add wave -noupdate -divider {processor_system_nios2_cpu: top-level ports}
...
add wave -noupdate -divider {processor_system_nios2_cpu: common}
...
add wave -noupdate -divider {processor_system_nios2_cpu: breaks}
