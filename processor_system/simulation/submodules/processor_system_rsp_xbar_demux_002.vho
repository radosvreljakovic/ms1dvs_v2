...
--synthesis_resources = 
 ...
 ENTITY  processor_system_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END processor_system_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF processor_system_rsp_xbar_demux_002 IS
 ...
 END RTL; --processor_system_rsp_xbar_demux_002
