...
--synthesis_resources = 
 ...
 ENTITY  processor_system_irq_mapper IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
 ...
 END processor_system_irq_mapper;

 ARCHITECTURE RTL OF processor_system_irq_mapper IS
 ...
 END RTL; --processor_system_irq_mapper
