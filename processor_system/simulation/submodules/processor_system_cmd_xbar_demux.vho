...
--synthesis_resources = 
 ...
 ENTITY  processor_system_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END processor_system_cmd_xbar_demux;

 ARCHITECTURE RTL OF processor_system_cmd_xbar_demux IS
 ...
 END RTL; --processor_system_cmd_xbar_demux
